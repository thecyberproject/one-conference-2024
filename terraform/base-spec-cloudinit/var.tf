...
variable "default_ci_cdrom_storage" {
  type = string
  description = "Set storage pool on which to mount the cloud init cdrom"
  default = "hddpool"
}
...
variable "ipconfig1_elements" {
  type        = string
  description = "additional config in raw format as: ip=192.168.10.20/24,gw=192.168.10.1"
  default     = null
}

variable "ipconfig2_elements" {
  type        = string
  description = "additional config in raw format as: ip=192.168.10.20/24,gw=192.168.10.1"
  default     = null
}

variable "ipconfig3_elements" {
  type        = string
  description = "additional config in raw format as: ip=192.168.10.20/24,gw=192.168.10.1"
  default     = null
}
...
variable "networks" {
  type        = list(any)
  description = "A addtional networks to attach to the VM. "
  default     = []
}
